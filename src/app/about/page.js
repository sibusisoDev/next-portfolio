...
export default function About() {
    return <section className="bg-white mx-auto max-w-screen-xl lg:py-16" id="about">
        <h1 className="font-bold text-4xl py-4 max-w-screen-xl px-4 mx-auto md:text-6xl tracking-tight leading-none">About Me</h1>
        <div className="py-4 px-4 lg:py-16">
            <div className="p-4 md:p-10 mb-6">
                <h1 className="text-gray-900 dark:text-white text-3xl md:text-5xl mb-2">👋 Welcome!
                    I'm <span className="underline underline-offset-1">Sibusiso</span>, a developer with a
                    passion for <span
                        className="underline underline-offset-1">front-end design and development</span></h1>
                ...
                <p className="text- mb-4 text-gray-900 lg:mb-8 md:text-lg lg:text-xl text-center">I'm
                ...
                <p className="mb-4 text-gray-900 lg:mb-8 md:text-lg lg:text-xl text-center">My
                    ...
                    digital world.
                    Feel free to explore my portfolio and connect with me on the socials for a chat. </p>
            </div>

            <div className="grid md:grid-cols-2 gap-8">
                <div
                    className="bg-black border border-white rounded-lg p-8 md:p-12 text-center">
                    <label
                        className="bg-white text-black text-sm inline-flex items-center px-2.5 py-0.5 rounded-md mb-2">
                        <CgWebsite className="mr-2"/>
                        Web Design
                    </label>
                    <h2 className=" text-white text-3xl mb-2">Crafting beautiful
                        and functional websites</h2>
                ...
                <div
                    className="border border-black rounded-lg p-8 md:p-12 text-center">
                    <label
                        className="bg-black text-white text-sm inline-flex items-center px-2.5 py-0.5 rounded-md  mb-2">
                    ...
                    <p className="text-lg font mb-4 text-gray-900 lg:mb-8 md:text-lg lg:text-xl">As
                        a web developer,
                        I get to turn ideas into reality by crafting websites and web applications.
                        I translate designs and functionalities into code, bringing them to life for users to
                        interact with.
